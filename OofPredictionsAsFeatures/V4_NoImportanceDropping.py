...
'''
10 fold (seed None):
    Without OOF (LGBM, cat): 0.3749831780778297, 0.37392302453671494
    With OOF (LGBM, cat): 0.3741128397954708, 0.3693782856130383
10 fold (seed 3333):
    Without OOF (LGBM, cat): 0.37781801295365186, 0.3777713783852804
    With OOF (LGBM, cat): 0.3753056990287959, 0.37478668885229244
'''
if __name__ == '__main__':
    ...
    joblib.dump(models_and_predictions, f'OofPredictionsAsFeatures/models_and_predictions/v4_{int(lgbm_rmse*10000)}_{int(cat_rmse*10000)}.p')